...
:sparkles: :sparkles: :sparkles: **More detailed explanations are given in the[ wiki](https://github.com/SebastiendOrnano/coop_sqlpage_custom_components/wiki)**  :sparkles: :sparkles: :sparkles:
...
## ChartModal (link in a rangeBar chart opened in a popup window)

A variant of chart1 to open a file on a click in a bar of the chart in a popup window.

## ChartModal1 ( double links in a rangeBar chart)

A combination  of chart1 and chart2 to open a file on a click in a bar of the chart in a popup window (link1) and another file from a click on a label on the y axis (link2).
